package com.napt.studentregister.lib.flatbutton.bar;
...
import com.napt.studentregister.lib.flatbutton.ProcessButton;
...
public class ActionProcessButton extends ProcessButton {
    ...
    private void init(Context context) {
        ...
        mColor1 = res.getColor(R.color.colorPrimary);
